...
var args47159 = [];
var len__33922__auto___47163 = arguments.length;
var i__33923__auto___47164 = (0);
while(true){
if((i__33923__auto___47164 < len__33922__auto___47163)){
args47159.push((arguments[i__33923__auto___47164]));

var G__47165 = (i__33923__auto___47164 + (1));
i__33923__auto___47164 = G__47165;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args47159.length)].join('')));
...
var G__47162 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__47162,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__47162;
}
});
...
var or__32847__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__33922__auto___47170 = arguments.length;
var i__33923__auto___47171 = (0);
while(true){
if((i__33923__auto___47171 < len__33922__auto___47170)){
args__33929__auto__.push((arguments[i__33923__auto___47171]));

var G__47172 = (i__33923__auto___47171 + (1));
i__33923__auto___47171 = G__47172;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__33930__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq47167){
var G__47168 = cljs.core.first.call(null,seq47167);
var seq47167__$1 = cljs.core.next.call(null,seq47167);
var G__47169 = cljs.core.first.call(null,seq47167__$1);
var seq47167__$2 = cljs.core.next.call(null,seq47167__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__47168,G__47169,seq47167__$2);
});
...
var file = cljs.core.get.call(null,map__47176__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__47176__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__47176__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__47176,map__47176__$1,file,line,column){
return (function (p1__47173_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__47173_SHARP_));
});})(map__47176,map__47176__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__33772__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__33772__auto__,prefer_table__33773__auto__,method_cache__33774__auto__,cached_hierarchy__33775__auto__,hierarchy__33776__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__32847__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__32847__auto__)){
return or__32847__auto__;
} else {
...
var temp__4657__auto___47178 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___47178)){
var message_47179 = temp__4657__auto___47178;
cljs.core.println.call(null,message_47179);
} else {
}
...
var temp__4657__auto___47180 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___47180)){
var message_47181 = temp__4657__auto___47180;
cljs.core.println.call(null,message_47181);
} else {
}
...
var temp__4655__auto__ = (function (){var and__32835__auto__ = typeof exception.stack === 'string';
if(and__32835__auto__){
var G__47191 = exception.stack;
var G__47191__$1 = (((G__47191 == null))?null:clojure.string.split_lines.call(null,G__47191));
var G__47191__$2 = (((G__47191__$1 == null))?null:cljs.core.get.call(null,G__47191__$1,depth));
if((G__47191__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__47191__$2);
}
} else {
...
var vec__47192 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__47192,(0),null);
var column = cljs.core.nth.call(null,vec__47192,(1),null);
var vec__47195 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__47195,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__47195,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__47195,(2),null);
...
var m__$1 = (function (){var G__47199 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__47199) {
case "fail":
...
var G__47205 = (function (){var G__47204 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__47204);
} else {
return G__47204;
}
})();
...
return cljs.core.vary_meta.call(null,G__47207,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__47211 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__47211) {
...
var vec__47216 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__47216,(0),null);
var types = vec__47216;
...
return cljs.core.map.call(null,(function (p__47228){
var vec__47229 = p__47228;
var ns = cljs.core.nth.call(null,vec__47229,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__47229,(1),null);
return ((function (vec__47229,ns,vars__$1){
return (function (){
...
var G__47232 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__47232) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__47232,env,once_fixtures,each_fixtures,vec__47229,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__47232,env,once_fixtures,each_fixtures,vec__47229,ns,vars__$1){
return (function (){
var seq__47233 = cljs.core.seq.call(null,vars__$1);
var chunk__47234 = null;
var count__47235 = (0);
var i__47236 = (0);
while(true){
if((i__47236 < count__47235)){
var v = cljs.core._nth.call(null,chunk__47234,i__47236);
var temp__4657__auto___47238 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___47238)){
var t_47239 = temp__4657__auto___47238;
each_fixture_fn.call(null,((function (seq__47233,chunk__47234,count__47235,i__47236,t_47239,temp__4657__auto___47238,v,each_fixture_fn,G__47232,env,once_fixtures,each_fixtures,vec__47229,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_47239)));
});})(seq__47233,chunk__47234,count__47235,i__47236,t_47239,temp__4657__auto___47238,v,each_fixture_fn,G__47232,env,once_fixtures,each_fixtures,vec__47229,ns,vars__$1))
);
} else {
}

var G__47240 = seq__47233;
var G__47241 = chunk__47234;
var G__47242 = count__47235;
var G__47243 = (i__47236 + (1));
seq__47233 = G__47240;
chunk__47234 = G__47241;
count__47235 = G__47242;
i__47236 = G__47243;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__47233);
if(temp__4657__auto__){
var seq__47233__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__47233__$1)){
var c__33658__auto__ = cljs.core.chunk_first.call(null,seq__47233__$1);
var G__47244 = cljs.core.chunk_rest.call(null,seq__47233__$1);
var G__47245 = c__33658__auto__;
var G__47246 = cljs.core.count.call(null,c__33658__auto__);
var G__47247 = (0);
seq__47233 = G__47244;
chunk__47234 = G__47245;
count__47235 = G__47246;
i__47236 = G__47247;
continue;
} else {
var v = cljs.core.first.call(null,seq__47233__$1);
var temp__4657__auto___47248__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___47248__$1)){
var t_47249 = temp__4657__auto___47248__$1;
each_fixture_fn.call(null,((function (seq__47233,chunk__47234,count__47235,i__47236,t_47249,temp__4657__auto___47248__$1,v,seq__47233__$1,temp__4657__auto__,each_fixture_fn,G__47232,env,once_fixtures,each_fixtures,vec__47229,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_47249)));
});})(seq__47233,chunk__47234,count__47235,i__47236,t_47249,temp__4657__auto___47248__$1,v,seq__47233__$1,temp__4657__auto__,each_fixture_fn,G__47232,env,once_fixtures,each_fixtures,vec__47229,ns,vars__$1))
);
} else {
}

var G__47250 = cljs.core.next.call(null,seq__47233__$1);
var G__47251 = null;
var G__47252 = (0);
var G__47253 = (0);
seq__47233 = G__47250;
chunk__47234 = G__47251;
count__47235 = G__47252;
i__47236 = G__47253;
continue;
}
} else {
...
});})(each_fixture_fn,G__47232,env,once_fixtures,each_fixtures,vec__47229,ns,vars__$1))
);
});})(each_fixture_fn,G__47232,env,once_fixtures,each_fixtures,vec__47229,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1479316902940