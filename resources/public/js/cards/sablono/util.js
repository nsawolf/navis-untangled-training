...
var x__33510__auto__ = (((x == null))?null:x);
var m__33511__auto__ = (sablono.util.to_str[goog.typeOf(x__33510__auto__)]);
if(!((m__33511__auto__ == null))){
return m__33511__auto__.call(null,x);
} else {
var m__33511__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__33511__auto____$1 == null))){
return m__33511__auto____$1.call(null,x);
} else {
...
var x__33510__auto__ = (((x == null))?null:x);
var m__33511__auto__ = (sablono.util.to_uri[goog.typeOf(x__33510__auto__)]);
if(!((m__33511__auto__ == null))){
return m__33511__auto__.call(null,x);
} else {
var m__33511__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__33511__auto____$1 == null))){
return m__33511__auto____$1.call(null,x);
} else {
...
var len__33922__auto___45626 = arguments.length;
var i__33923__auto___45627 = (0);
while(true){
if((i__33923__auto___45627 < len__33922__auto___45626)){
args__33929__auto__.push((arguments[i__33923__auto___45627]));

var G__45628 = (i__33923__auto___45627 + (1));
i__33923__auto___45627 = G__45628;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__33930__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq45625){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45625));
});
...
var vec__45632 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__45634;
var words = seq__45633__$1;
...
var G__45636 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__45636,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__45636;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__45637_SHARP_){
if(typeof p1__45637_SHARP_ === 'string'){
return p1__45637_SHARP_;
} else {
return cljs.core.seq.call(null,p1__45637_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__32847__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1479316901986